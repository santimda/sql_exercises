...
-- Create job_posting_fact table with primary key
...
-- Set ownership of the tables to the user santimda
ALTER TABLE public.company_dim OWNER TO santimda;
ALTER TABLE public.skills_dim OWNER TO santimda;
ALTER TABLE public.job_posting_fact OWNER TO santimda;
ALTER TABLE public.skills_job_dim OWNER TO santimda;
